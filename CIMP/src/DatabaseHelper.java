 ...
 */
    public ResultSet select(String columnList, String tableList, String condition, String sort)
    {
        Statement s = null;
        ResultSet rs = null;
     ...
     * @return boolean True if rows were affected, false if 0 rows were affected (failed insert)
     */
    public boolean insert(Array[][] newRecord, String tableName)
    {
        Statement s = null;
        String fieldList = "( ";
        String valueList = "( ";
       ...
       String insertStatement = "INSERT INTO " + tableName + " " + fieldList + " VALUES " + valueList;
     ...
     * @return boolean True if rows were affected, false if 0 rows were affected (failed update)
     */
    ...
    {
        Statement s = null;
        String deleteStatement = "DELETE FROM " + tableName + " WHERE " + condition;
