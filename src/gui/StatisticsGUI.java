...
/**
 * Purpose: The GUI for the statistics page to view stats as well as generate
 * quarterly reports.
 * 
 * @author CST215
 *
...
public class StatisticsGUI extends Application
{
     ...
     */
    public void reportsMainStageConstruct( Stage stage,
    ...
    /**
     * Purpose: Creates the VBox containing the list of categories to view
     * statistics on, as well as the dates between which the records should be
     * pulled from, and a button to generate the quarterly report.
     * 
     * @return the VBox containing the list of categories, dates between which
     *         the records should be pulled from, and the button to generate the
     *         quarterly report.
     */
    private VBox createCategoriesBox()
    {
        ...
        ObservableList categoriesList = FXCollections.observableArrayList(
                "Allergies", "Seizures", "Medications", "Vaccinations",
                "Heart Conditions", "Lung Conditions", "Falls Over Time",
                "Age Groups", "Lift Usage", "Catheters", "Injections Given");
     ...
     * 
     * @return a TabPane object containing the tabs for the participants, forms
     *         and statistics page
     */
                ...
                .addListener(new ChangeListener<Tab>()
                {
                            ...
                            Tab arg1, Tab mostRecentlySelectedTab )
                    {
                        ...
                        else if ( mostRecentlySelectedTab.equals(participants) )
                        {
                            ...
                            gui.medMainPageConstruct(reportsMainStage,
                                    loggedInStaff);
                        }
    ...
    /**
     * Purpose: Create the Bar Chart to display the statistical information
     * 
    ...
    private BarChart createGraphBox()
    {
        ...
        BarChart<String, Number> chart = new BarChart<String, Number>(xAxis,
                yAxis);
    ...
    /**
     * Purpose: Creates the VBox containing all of the other nodes on the page.
     * 
     * @return VBox the VBox holding the bar chart, as well as categories list,
     *         datepickers, and generate reports button.
     */
