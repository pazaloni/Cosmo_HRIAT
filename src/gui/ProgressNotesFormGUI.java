...
public class ProgressNotesFormGUI
{
     ...
     */
    public ProgressNotesFormGUI(Tab progressNotesTab,
            StaffAccount loggedInUser, Stage parentStage)
    {
    ...
    private VBox createProgressNote( String cosmoId )
    {
                ...
                .setOnMouseClicked(event -> {
                    ...
                    else
                    {
                        ManageProgressNoteGUI manageProgressNote = new ManageProgressNoteGUI(
                                parentStage);
                        manageProgressNote.showUpdateProgressNote(progressNote,
                                cosmoId);
                        controller.refreshTable(cosmoId);
                    }
                });
        btnDeleteProgressNote
                .setOnMouseClicked(event -> {
                    ProgressNotes progressNote = controller.getSelectedPK();
                    if ( progressNote == null )
                    {
                    ...
                    else
                    {
                        ...
                        if ( popup.runCheck() )
                        {
                            ProgressNotes.deleteProgressNote(table
        ...
        buttons.getChildren().addAll(btnAddProgressNote, btnEditProgressNote,
                btnDeleteProgressNote);
