    ...
    public Tab showPersonalCare( String cosmoId )
    {
        ...
        btnSave.setOnAction(new EventHandler<ActionEvent>()
        {
            ...
            public void handle( ActionEvent e )
            {
                ...
                helper.savePersonalCareInformation(valArray,
                        assistanceCBOBox.getValue(), nowString, cosmoId);
        ...
        CheckBox suprapubicChk = new CheckBox(
                "Monthly Suprapubic Catherter Change");
        ...
        // observable list to store the values that are displayed in the combo
        // box
        ...
        contentBox.getChildren().addAll(titleBox, subHeaderBox, insulinBox,
                depoBox, bTwelveBox, suprapubicBox, dressingBox, cobanBox,
                ostomyBox, catheterBox, trachBox, feedBox, dietBox,
                assistanceBox);
