...
/**
 * Data-holder class for the OlderAdultNeedsController. This is used to hold
 * data to put into the Older Adult Needs TableView in the QuarterlyReportsGUI.
 * 
...
public class OlderAdultsNeeds
{
     ...
     *            at elmwood.
     * @param lutherCare The number of participants in the age group to be
     *            living at luther care.
     * @param other The number of participants in the age group living
     *            elsewhere.
     * @param totalAsOf The total participants in this age group as of the
     *            current date.
     * @param totalForLastYear The total participants in this age group last
     *            year
     * 
     * @author Breanna Wilson, Jon Froese
     */
    public OlderAdultsNeeds(String age, int longTermCare, int elmwood,
            int lutherCare, int other, int totalAsOf, int totalForLastYear)
    {
        this.age = age;
    ...
    /**
     * Returns a string property of participants in long term care.
     * 
    ...
    /**
     * Returns the string property for the number of participants living at
     * elmwood
     * 
     * @return The string property for the number of participants living at
     *         elmwood
     * 
     * @author Breanna Wilson, Jon Froese
     */
    ...
    /**
     * Returns the number of participants in luther care.
     * 
     * @return The number of participants in luther care.
     * 
     * @author Breanna Wilson, Jon Froese
     */
    ...
    /**
     * Returns the string property for the number of participants in luther
     * care.
     * 
     * @return The string property for the number of participants in luther
     *         care.
     * 
     * @author Breanna Wilson, Jon Froese
     */
    ...
    /**
     * Returns the string property for the number of participants living
     * elsewhere
     * 
     * @return The string property for the number of participants living
     *         elsewhere.
     * 
     * @author Breanna Wilson, Jon Froese
     */
    ...
    /**
     * Returns the total number of participants as of the current date.
     * 
     * @return The total number of participants as of the current date.
     * 
     * @author Breanna Wilson, Jon Froese
     */
    ...
    /**
     * Returns the string property for the total number of participants as of
     * the current date.
     * 
     * @return The string property for the total number of participants as of
     *         the current date.
     * 
     * @author Breanna Wilson, Jon Froese
     */
    ...
    /**
     * Returns the string property for the total number of participants for last
     * year.
     * 
     * @return The string property for the total number of participants for last
     *         year.
     */
