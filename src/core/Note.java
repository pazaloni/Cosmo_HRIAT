...
public class Note
{
     ...
     * @param dateCreated The date that the note was created
     * @param viewed If the note has been seen by the medical administrator
     * @param resolved If the note has been marked as resolved by the medical
     *            administrator
