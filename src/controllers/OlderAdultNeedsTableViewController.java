...
/**
 * The controller for the Older Adults Needs tableview for the Quarterly Reports
 * Preview GUI.
 * 
 * This will take care of handling putting data into the tableview, as well as
 * the tableview's layout.
 * 
...
public class OlderAdultNeedsTableViewController
{
    ...
    private TableColumn<OlderAdultsNeeds, String> ageColumn = new TableColumn<OlderAdultsNeeds, String>(
            "Age");
    private TableColumn<OlderAdultsNeeds, String> longTermCareColumn = new TableColumn<OlderAdultsNeeds, String>(
            "Long Term Care Facility");
    private TableColumn<OlderAdultsNeeds, String> elmwoodColumn = new TableColumn<OlderAdultsNeeds, String>(
            "Elmwood Res");
    private TableColumn<OlderAdultsNeeds, String> lutherCareColumn = new TableColumn<OlderAdultsNeeds, String>(
            "Luther Care");
    private TableColumn<OlderAdultsNeeds, String> otherColumn = new TableColumn<OlderAdultsNeeds, String>(
            "Other");
    private TableColumn<OlderAdultsNeeds, String> totalAsOfColumn = new TableColumn<OlderAdultsNeeds, String>(
            "totalAsOfPH");
    private TableColumn<OlderAdultsNeeds, String> totalForLastYearColumn = new TableColumn<OlderAdultsNeeds, String>(
            "totalForLastYearPH");

    public ObservableList<OlderAdultsNeeds> adultData = FXCollections
            .observableArrayList();

    private DatabaseHelper db = new DatabaseHelper();

    /**
     * Initializes the tableview, pulls the data from the database and puts it
     * into the tableview.
     * 
     * @author Breanna Wilson, Jon Froese
     */
    ...
    /**
     * Queries the database for participants care types, and calculates who is
     * living in long term care facilities, elmwood, luther care, or other care
     * arrangements. It shows the total up to the end date selected. All of the
     * information is sorted by age groups.
     * 
     * @author Breanna Wilson, Jon Froese
     */
    ...
    private void queryAdultsNeedsData()
    {
        ...
        ResultSet rs = db.select("careType, address, dateOfBirth",
                "Participant", "", "");
        ...
        try
        {
            ...
            from60to65 = new OlderAdultsNeeds("60-65", from60to65LongTermCount,
                    from60to65ElmwoodResCount, from60to65LutherCareCount,
                    from60to65OtherCount, 0, 0);
            from55to59 = new OlderAdultsNeeds("55-59", from55to59LongTermCount,
                    from55to59ElmwoodResCount, from55to59LutherCareCount,
                    from55to59OtherCount, 0, 0);
            from50to54 = new OlderAdultsNeeds("50-54", from50to54LongTermCount,
                    from50to54ElmwoodResCount, from50to54LutherCareCount,
                    from50to54OtherCount, 0, 0);
            from40to49 = new OlderAdultsNeeds("40-49", from40to49LongTermCount,
                    from40to49ElmwoodResCount, from40to49LutherCareCount,
                    from40to49OtherCount, 0, 0);
            from30to39 = new OlderAdultsNeeds("30-39", from30to39LongTermCount,
                    from30to39ElmwoodResCount, from30to39LutherCareCount,
                    from30to39OtherCount, 0, 0);
            from20to29 = new OlderAdultsNeeds("<29", from20to29LongTermCount,
                    from20to29ElmwoodResCount, from20to29LutherCareCount,
                    from20to29OtherCount, 0, 0);
            // add each object into the tableview data list
            adultData.addAll(over65, from60to65, from55to59, from50to54,
                    from40to49, from30to39, from20to29);
    ...
    /**
     * Clears the tableview and the observablelist, re-queries the database, and
     * places the fresh data into the list and then the tableview.
     * 
     * @author Breanna Wilson, Jon Froese
     */
    ...
    /**
     * Initializes the tableview. The tablecolumns are set up to pull data from
     * the data holder object, and are put into the tableview.
     * 
     * @author Breanna Wilson, Jon Froese
     */
