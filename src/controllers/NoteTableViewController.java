...
public class NoteTableViewController
{
    ...
    private TableColumn<Note, String> statusColumn = new TableColumn<Note, String>(
            "New");
    ...
    private void initializeNoteData()
    {
        ...
        ResultSet rs = db.select("*", "Notes", "(((Notes.resolved)=False))",
                "noteID");
    ...
    public Note getNoteFromID( String id )
    {
        ...
        int index = noteIDs.indexOf(new Note(intID, 0, null, null, null, false,
                false));
