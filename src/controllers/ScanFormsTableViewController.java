...
public class ScanFormsTableViewController
{
    ...
    private void retrieveScanFormsData( String cosmoId )
    {
        ...
        try
        {
            while ( rs.next() )
            {
                ...
                int month = Integer
                        .parseInt(scannedDate.substring(0, monthEnd));
                ...
                ScanForms scannedForm = new ScanForms(dateSaved, description,
                        fileName);
    ...
    private void initialize()
    {
        ...
        scanTable.getColumns().addAll(dateSavedColumn, fileNameColumn);
    }
}
