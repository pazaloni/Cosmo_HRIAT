...
/**
 * Purpose: This is the controller for accessing the database in order to
 * populate the participant information update form with the relevant infomation
...
public class ParticipantUpdateFormController
{
    ...
    /**
     * Purpose:This will get the information needed for the form for the
     * selected participant, and return it in the form of string array
     * 
     * @return A String array containing all the relevant data to the
     *         participant
     * 
     * @author Breanna Wilson cst215 Steven Palchinski cst209
     */
    ...
    public String[] fetchKinInfo()
    {
        ...
        // query the participant table to get the kin ID of the selected
        // participant
        ResultSet rsKinID = db.select("kinID", "Participant", "cosmoID ="
                + cosmoID, "");
        ...
        ResultSet rs = db.select(
                "firstName, lastName, address, city, postalCode,"
                        + "homePhoneNumber, workPhoneNumber", "Kin", "kinID ="
                        + kinID, "");
        try
        {
    ...
    public String[] fetchCaregiverInfo()
    {
        ...
        // connect to the database
        db.connect();
        // query the database to get the caregiver id for the selected
        // participant
        ResultSet rsCGID = db.select("caregiverID", "Participant", "cosmoID ="
                + cosmoID, "");
        ...
        // query the Caregiver table to get the relevant information for that
        // participant
        ResultSet rs = db.select(
                "firstName, lastName, address, city, postalCode,"
     ...
     * form for the selected participant, and return it in the form of string
     * array
     * 
     * @return A String array containing all the relevant data for the
    ...
    public String[] fetchEmergencyContactInfo()
    {
        ...
        // connect to the database
        db.connect();
        // query the database to get the emergency contact id for the
        // participant
        ...
        try
        {
            // while there is still an entry for the ResultSet, set the
    ...
    /**
     * Purpose: Save the information for a kin record. If the information has
     * changed, it is assumed to be a new person, and a new record will be
     * created, else it will stay the same.
     * 
     ...
     * @return - a String containing any error messages produced during data
     *         validation process.
     * @author Breanna Wilson CST215
     */
    public String saveKinInformation( String firstName, String lastName,
            ...
            String workPhone )
    {
        ...
        msg = validateKinInformation(firstName, lastName, address, city,
                postalCode, homePhone, workPhone);
    ...
    /**
     * Purpose: Saves caregiver information if it has been updated, and creates
     * a new record. Else, it will stay the same.
     * 
            ...
            String workPhone )
    {
        ...
        if ( caregiverID.equals("") || caregiverID.equals(null)
                || caregiverID.equals(" ") )
        {
            msg = validateCaregiverInformation(firstName, lastName, address,
            ...
            if ( msg.equals(null) || msg.equals("") )
            {
                ...
                try
                {
                    if ( rs.next() )
                    {
                        ...
                        // update the participant record
                        db.update(caregiverInfo, "Participant",
                                caregiverInfo[0][1]);
                    }
                    else
                    {
    ...
    /**
     * Purpose: If the emergency contact information has been updated, create a
     * new emergency contact record, and update the participant record to use
     * this emergency contact. Else, nothing changes.
     * 
     ...
     * @author Breanna Wilson CST215
     */
    public String saveEmergencyContactInformation( String firstName,
            String lastName, String phone )
    {
        ...
        ResultSet rs = db.select("emergencyContactID", "EmergencyContact",
                whereStmt, "");
        ...
        {
            msg = validateEmergencyContactInforamtion(firstName, lastName,
                    phone);
            ...
            if ( msg.equals(null) || msg.equals("") )
            {
                ...
                rs = db.select("emergencyContactID", "EmergencyContact",
                        whereStmt, "");
    ...
    /**
     * Purpose: creates the string to put into the WHERE clause of queries.
     * 
     * @param values - the values to be used in the WHERE clause
     * @param length - the length of the first dimension of the array
    ...
    /**
     * Purpose: Will validate that a phone number is in the format(s):
     * XXX-XXX-XXXX XXX-XXXX X-XXX-XXX-XXXX
     * 
    ...
    /**
     * Purpose: Will validate that a postal code is in the proper format A1A
     * 1A1.
     * 
    ...
    /**
     * Purpose: Will validate that an address is in the format: 111 Fake St
     * 
    ...
    /**
     * Purpose: Will validate that a city name contains only letters and
    ...
    /**
     * Purpose: Will validate that a name only contains letters, dashes, and
     * periods.
     * 
    ...
    /**
     * Purpose: Validate all fields for kin information that they are in the
     * correct format.
     * 
     ...
     * @return - String with all error messages. If the string is empty, all
     *         fields are valid.
     * @author Breanna Wilson CST215
     */
    private String validateKinInformation( String firstName, String lastName,
            String address, String city, String postalCode, String homePhone,
            String workPhone )
    {
        String message = "";
        ...
        if ( ((firstName == null || firstName.equals("")) || (lastName == null || lastName
                .equals(""))) )
        {
    ...
    /**
     * Purpose: Validate that all caregiver information is in the correct
     * format.
     * 
     ...
     * @return - Any error messages. Will be empty if there are no errors.
     * @author Breanna Wilson CST215
     */
    private String validateCaregiverInformation( String firstName,
            String lastName, String address, String city, String postalCode,
    ...
    /**
     * Purpose: Validates the emergency contact information, and that it is in
     * the correct format.
     * 
     ...
     * @author Breanna Wilson CST215
     */
    private String validateEmergencyContactInforamtion( String firstName,
            String lastName, String phone )
    {
        String message = "";
