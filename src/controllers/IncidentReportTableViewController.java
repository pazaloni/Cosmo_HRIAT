...
public class IncidentReportTableViewController
{
    ...
    public void initialize()
    {
        ...
        incidentIDColumn.setCellValueFactory(cellData -> cellData.getValue().getReportID());
        incidentIDColumn.setMinWidth(50);
        incidentIDColumn.setResizable(false);
        
        cosmoIDColumn.setCellValueFactory(cellData -> cellData.getValue().getCosmoID());
        cosmoIDColumn.setMinWidth(50);
        cosmoIDColumn.setResizable(false);
        
        dateOfIncidentColumn.setCellValueFactory(cellData -> cellData.getValue().getDateOfIncident());
        dateOfIncidentColumn.setMinWidth(100);
        dateOfIncidentColumn.setResizable(false);
        
        timeOfIncidentColumn.setCellValueFactory(cellData -> cellData.getValue().getTimeOfIncident());
    ...
    /**
     * Purpose: To get the primary key from the row of the table that is selected
