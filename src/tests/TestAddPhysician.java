...
public class TestAddPhysician
{
    ...
    //db helper used to initially access the database and make select statements
    ...
    public void test()
    {
        ...
        //using the values pullled from the database fo rphys id =1, make a physician object
