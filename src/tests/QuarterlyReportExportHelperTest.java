...
public class QuarterlyReportExportHelperTest {
	...
	public void setUp() throws Exception 
	{
		...
		PersonalCare p = new PersonalCare("Medical", "Daily Insulin Injections", "2");
		...
		ObservableList olderAdultNeedsList = FXCollections.observableArrayList();
		OlderAdultsNeeds o = new OlderAdultsNeeds(">65", 0, 1, 1, 0, 2, 0);
		olderAdultNeedsList.add(o);
		
		exportHelper = new QuarterlyReportExportHelper(personalCareList, reactiveCareList,
				olderAdultNeedsList, "22-Apr-2016", 2015);
	}

	/**
	 * Purpose: Test the createPersonalCareCSVString() method, and
	 * that it exports a string as expected given the correct information.
	 */
	@Test
	public void testCreatePersonalCareCSVString() 
	{
		assertTrue(exportHelper.createPersonalCareCSVString().equals(personalCare));
	}

	/**
	 * Purpose: Test the createReactiveCareCSVString() method, and
	 * that it exports a string as expected given the correct information.
	 */
	@Test
	public void testCreateReactiveCareCSVString() 
	{
		assertTrue(exportHelper.createReactiveCareCSVString().equals(reactiveCare));
	}
	
	/**
	 * Purpose: Test the createOlderAdultNeedsCSVString() method, and
	 * that it exports a string as expected given the correct information.
	 */
	@Test
	public void testCreateOlderAdultNeedsCSVString()
	{
		assertTrue(exportHelper.createOlderAdultNeedsCSVString().equals(olderAdultNeeds));
	}
