...
/**
 * Tests the PersonalCare data holder object, and it's getter methods.
 * 
...
public class PersonalCareTest
{
    ...
    public void setUp() throws Exception
    {
        ...
        totalAsOf = "1";
        totalForLastYear = "2";
        pc = new PersonalCare("", supports, totalAsOf);
    }

    /**
     * Test the getSupports() method returns the expected String value.
     * 
     * @author Breanna Wilson, Jon Froese
     */
    @Test
    ...
    /**
     * Test the getSupportsProperty() method returns a StringProperty with the
    ...
    /**
     * Test the getTotalAsOf() method returns the expected String.
     * 
     * @author Breanna Wilson, Jon Froese
     */
    @Test
    ...
    /**
     * Test the getTotalAsOfStringProperty() returns a StringProperty containing
    ...
    /**
     * Test the getTotalForLastYear() method returns the expected String value.
     * 
     * @author Breanna Wilson, Jon Froese
     */
    @Test
    ...
    /**
     * Test the getTotalForLastYearProperty() returns a StringProperty with the
     * expected String value.
     * 
     * @author Breanna Wilson, Jon Froese
     */
    ...
    {
        assertTrue(totalForLastYear.equals(pc.getTotalForLastYearProperty()
                .getValue()));
    }
