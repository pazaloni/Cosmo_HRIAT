...
public class TestEncryption
{
    ...
    public void testGetPassword()
    {
        ...
        String results1 = testHelper.addUser(usernameOne, lastNameOne,
                firstNameOne, emailOne, firstPasswordOne, secondPasswordOne,
                securityOne);
        // compare original plain text password matches the password from the
        // database
        assertTrue(firstPasswordOne.equals(testHelper.queryStaff(usernameOne)
                .GetPassword()));

    }

    /**
     * To test that a new account will have the password that is encrypted
     * properly
     */
    @Test
    public void createUser()
    {
        ...
        String results2 = testHelper.addUser(usernameTwo, lastNameTwo,
                firstNameTwo, emailTwo, firstPasswordTwo, secondPasswordTwo,
                securityTwo);
        // confirm that the password entered matches the decrypted password from
        // the database
        assertTrue(firstPasswordTwo.equals(testHelper.queryStaff(usernameTwo)
                .GetPassword()));
    }
