...
public class ManagePhysicianAccountHelper
{
     ...
     * successfully
     * 
     * @param phone : the phone number the user passed in
     ...
     * @param phone : the phone number the user passed in
     * @param lastName : the lastname the user passed in
     * @param firstName : the firstName the user passes in
     * @param physID : the primary key used to grab the correct record to edit
     */
