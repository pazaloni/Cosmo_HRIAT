...
public class StatisticsHelper
{
     ...
     * 
     * @param searchFor the table you are looking in
     * @param comparison the operator you are using
     * @param condition the limiter on your query results
     * @return
     */
     ...
     * 
     * @param tableName the table whose headings we are requesting
     * @return
     */
