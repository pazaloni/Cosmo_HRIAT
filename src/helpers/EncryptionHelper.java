...
{
    // The byte array permanently set in order to maintain consistent
    // encrypting/decrypting
    private static final byte[] KEY = { 12, -89, -94, -38, 6, 18, -43, 67, -62,
            71, -114, -113, 7, 33, -97, 26 };
    // instance of the Cipher used for encrypting/decrypting
    Cipher cipher;
    // instance of the SecretKey. Allows the coder to use a pre-existing byte
    // array
    ...
    {
        // generate the secret key using the passed in byte array and using the
        // AES algorithm
    ...
    public String encrypt( String plainText )
    {
        ...
        // create a 64 bit encoder to translate the encrypted byte array to a
        // string
    ...
    {
        // create the 64 bit decoder to translate the encrypted string to a
